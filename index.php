...
<html lang="en">
  ...
  <body id="page-top">
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger logo" href="#page-top" title="Will Hough"><img src="/img/wh.png"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="/resume#resume">Resume</a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div class="container my-auto">
        <div class="row">
          <div class="col-lg-10 mx-auto">
            <h1 class="text-uppercase">Design &amp; Create</h1>
            <hr>
          </div>
          <div class="col-lg-9 mx-auto">
            <p class="text-faded mb-5">I can help you build better things.</p>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-9 mx-auto text-center">
            <h2 class="section-heading text-white">I have the knowledge you need.</h2>
            <hr class="light my-4">
            <h5 class="text-white">Seasoned Web Designer, Front End Developer, Photographer &amp; Graphic Designer.</h5>
            <p class="text-faded mb-4">Adept and creative multitasker capable of working simultaneously on multiple projects. Detail oriented and deadline driven with an aptitude to effectively work independently &amp; in a team environment.</p>
            <a class="btn btn-light btn-xl js-scroll-trigger" href="#services">What Do I Do?</a>
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 text-center">
            <div class="service-box mt-5 mx-auto">
              ...
              <h3 class="mb-3">Fast Turnaround</h3>
              <p class="text-muted mb-0"></p>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 text-center">
            ...
            <a class="portfolio-box" target="core77.com"  href="https://boards.core77.com/">
              ...
              <div class="portfolio-box-caption">
                <div class="portfolio-box-caption-content">
                  ...
                  <div class="project-name">Core77 Boards</div>
                  <p>PHPBB, HTML, CSS, MYSQL, PHP</p>
                </div>
              </div>
            </a>
          </div>
          <div class="col-lg-4 col-sm-6">
            <a class="portfolio-box" target="mindovermatterrecords.com" href="http://www.mindovermatterrecords.com/">
              ...
              <div class="portfolio-box-caption">
                <div class="portfolio-box-caption-content">
                  <div class="project-category text-faded">Website</div>
                  <div class="project-name">Mind Over Matter Records</div>
                  <p>HTML, CSS, PHP, Bootstrap 4, Photoshop</p>
                </div>
              </div>
            </a>
          </div>
            ...
            <a class="portfolio-box" data-fancybox="hotgm" data-caption="<h4>Restaurant menu concept for Hermann's Olde Town Grill</h4><p>Adobe Illustrator, Digital Press, White 14pt Cornwall Cover</p>" href="img/portfolio/hermanns/menu/01.png">
              ...
              <div class="portfolio-box-caption">
                <div class="portfolio-box-caption-content">
                  ...
                  <div class="project-name">Hermann's Olde Town Grill</div>
                  <p>Illustrator</p>
                </div>
              </div>
            </a>
            ...
            <a class="portfolio-box" href="/menu/">
              ...
              <div class="portfolio-box-caption">
                <div class="portfolio-box-caption-content">
                  ...
                  <div class="project-name">HTML Restaurant Menu</div>
                  <p>HTML, CSS, Bootstrap 3</p>
                </div>
              </div>
            </a>
          </div>
            ...
            <a class="portfolio-box" data-fancybox="album" data-caption="<h4>Album cover for Man Mountain <small>To call each thing by it's name</small></h4><p>Adobe Photoshop</p>" href="img/portfolio/album/MM-to_call.png">
              ...
              <div class="portfolio-box-caption">
                <div class="portfolio-box-caption-content">
                  ...
                  <div class="project-name">Man Mountain</div>
                  <p>Photoshop, Photography</p>
                </div>
              </div>
            </a>
          ...
          <div class="col-lg-4 col-sm-6">
            <a class="portfolio-box" data-fancybox="album" data-caption="<h4>Album cover for Glassfield</h4><p>Adobe Photoshop</p>" href="img/portfolio/album/GF.png">
              ...
              <div class="portfolio-box-caption">
                <div class="portfolio-box-caption-content">
                  <div class="project-category text-faded">Album Cover</div>
                  <div class="project-name">Glassfield</div>
                  <p>Photoshop, Photography</p>
                </div>
              </div>
            </a>
          ...
          <div class="col-lg-4 col-sm-6 m-auto">
            <a class="portfolio-box" data-fancybox="album" data-caption="<h4>Album cover for Rhone <small>Inter Sidera</small></h4><p>Adobe Photoshop</p>" href="img/portfolio/album/RH.png">
              ...
              <div class="portfolio-box-caption">
                <div class="portfolio-box-caption-content">
                  <div class="project-category text-faded">Album Cover</div>
                  <div class="project-name">Rhone</div>
                  <p>Photoshop, Photography</p>
                </div>
              </div>
            </a>
    ...
    <section class="bg-dark text-white">
      <div class="container text-center">
        <h2 class="mb-4">Would you like to check out my Resume?</h2>
        <a class="btn btn-light btn-xl sr-button" href="/resume">Heck Yea!</a>
      </div>
    </section>
    <section id="contact">
      <div class="container">
